...
const header__icon = document.querySelector(".header-icons");
const kurv = document.querySelector(".kurv");
const luk__kurv = document.querySelector("#luk__kurv");
header__icon.addEventListener("click", () => kurv.classList.add("aktiv"));
...
let webshop__kurv__produkt__taeller = 0;
const opdater__kurv__indhold = change => {
    const opdater__kurv__indhold__banner = document.querySelector(".webshop__kurv__produkt__taeller");
    webshop__kurv__produkt__taeller += change;
    if (webshop__kurv__produkt__taeller > 0){
        opdater__kurv__indhold__banner.style.visibility = "visible";
        opdater__kurv__indhold__banner.textContent = webshop__kurv__produkt__taeller;
    } else {
...
tilfoej__til__kurv.addEventListener("click", () => {
    ...
    webshop__kurv__produkt__taeller = 0;
